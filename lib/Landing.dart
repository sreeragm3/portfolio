  ...
  Widget build(BuildContext context) {
    ...
    if (screenWidth < 600){
      ...
      return  Scaffold(
        ...
        ),height: third_h*0.25,width:screenWidth*40 ,decoration: BoxDecoration(color: Colors.white),),
          Container(child: Row(mainAxisAlignment: MainAxisAlignment.center,children: [Container(child: Center(child: Text(hello,style: TextStyle(color: Colors.white,fontFamily: 'SPARTEN',fontSize: port*0.6),)),decoration: BoxDecoration(color: Colors.black,borderRadius: BorderRadius.circular(32)),height: third_h*0.4,width: third_w*0.6,),SizedBox(height: third_h*0.05,width: third_w*0.05),Container(child: Column(children: [Padding(
            padding:  EdgeInsets.fromLTRB(0, third_h*0.005, 0, third_h*0.015),
            child: Container(height: third_h*0.19,width: third_w*0.3,decoration: BoxDecoration(color: Color(0xFFA9DAD7),borderRadius: BorderRadius.circular(32)),),
          ),Container(decoration: BoxDecoration(color: Color(0xFF8e6fbd),borderRadius: BorderRadius.circular(32)),height: third_h*0.185,width: third_w*0.3),],),decoration: BoxDecoration(color: Colors.white,borderRadius: BorderRadius.circular(32)),height: third_h*0.4,width: third_w*0.3)],),height: 290,width:screenWidth*40,decoration: BoxDecoration(color: Colors.white),),
